...
```{r}
bids <- 1
indices <- c(1242, 1181, 1277, 1120, 1155, 1395, 1348, 1371, 
             1301, 1328, 1113, 1393, 1308, 1158, 1137, 1233, 
             1335, 1437 ,1345, 1403, 1455, 1452, 1196, 1116,
             1439, 1104, 1139, 1382, 1417, 1293, 1267, 1372,
             1168, 1254, 1347, 1462, 1314, 1276, 1211, 1326, 
             1222, 1401, 1281, 1199, 1344, 1361, 1355, 1422, 
             1285, 1252, 1300, 1411, 1438, 1153, 1397, 1112, 
             1246, 1274, 1305, 1166, 1243, 1400, 1260, 1172, 
             1138, 1460, 1209, 1420
...
for(i in 1:(length(indices)-1)){
  for(j in (i+1):length(indices)){
    GameID[game] = paste("2018", indices[i], indices[j], sep='_')
    prob[game] = MOVp[i,j]
    game=game+1
  }
}
